...
HD_PWD='C:/Users/aakas/Desktop/project_5/project_5/project_5/project_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log processorout.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source processorout.tcl -notrace
