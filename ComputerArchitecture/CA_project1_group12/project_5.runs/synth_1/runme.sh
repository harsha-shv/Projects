...
HD_PWD='C:/Users/aakas/Desktop/project_5/project_5/project_5/project_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log processorout.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source processorout.tcl
